...
public class SciFiName   
{
    ...
    public static void main()
    {
        ...
        int b = (int)(Math.random() * relativeName1.length());
        
        int c = (int)(Math.random() * relativeName2.length());
        
        String scifiOrigin = relativeName1.substring(b) + relativeName2.substring(c);
